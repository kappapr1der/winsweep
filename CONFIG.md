...
- `scheduledGuardCooldownMinutes`: не запускать второй фоновый контроль места вскоре после первого. По умолчанию 45 минут; ручные действия из GUI это ограничение не затрагивает.

Spotify намеренно исключён из автоматической очистки. В Store-версии часть
папок кэша связана с состоянием встроенного интерфейса, поэтому её обслуживание
следует выполнять только вручную через настройки самого Spotify.
