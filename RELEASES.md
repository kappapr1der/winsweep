...
```powershell
.\build-release.ps1 -Version 1.2.0 -Portable
```

Готовый файл появится в `dist\WinSweep-Portable-v1.2.0.zip`. После первого
...
```powershell
.\publish-release.ps1 -Version 1.2.0 -Portable
```

Сценарий собирает ZIP, создаёт или использует тег `v1.2.0` и прикрепляет архив
...
```powershell
.\publish-release.ps1 -Version 1.2.0 -Portable -DryRun
.\publish-release.ps1 -Version 1.2.0 -Portable -Prerelease
.\publish-release.ps1 -Version 1.2.0 -Portable -UpdateExisting -ReplaceAsset
