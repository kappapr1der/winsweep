...
Основной способ работы с WinSweep теперь — `winsweep-ui.bat`. Он открывает единое
окно Control Center с дашбордом дисков, быстрыми действиями, переключателями кэшей,
планировщиком, историей и журналом запуска.
